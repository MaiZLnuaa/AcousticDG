...
# mesh_file = os.path.join(this_dir, "result13500.vtu")
mesh_file = os.path.join(this_dir,  "../highorder_results", "result13500.vtu")
...
txt_file = os.path.join(this_dir, "dipolejxj.txt")
